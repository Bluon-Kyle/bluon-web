...
import video from '../../../media/video/BluonTechPortal.mp4';
import app_img from '../../../media/image/bluon-app-logo.png';
const MostLovedApp = () => {
    const app_phone = require('../../../media/image/testi-phone.png');
  return (
    <div className='mla'>
        <div className='mla-top'>
            ...
            <span className='mla-top-text'>
                ...
                <h2>"Bluon is the best app that you can<br></br>
                possibly get."</h2>
            </span>
        </div>
        ...
        <div className='mla-video'>
            <video className='video' autoPlay playsInline muted loop src={video}></video>
        </div>
