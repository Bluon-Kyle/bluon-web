export const sectionList = [
    ...
    },
    {
        ...
        content: ["These content standards apply to any and all User Contributions. User Contributions must entirety comply with all applicable federal, state, local, and international laws and regulations. Without limiting the foregoing, User Contributions must not:"],
        list: [
    ...
    {
        title: '15. Waiver and Severability',
        content: [
    ...
    {
        bigtitle:'Communications Policy',
        loudtitle:'Bluon, Inc',
        content:[
    ...
    },
    {
        ...
        loudtitle: 'DIGITAL MILLENNIUM COPYRIGHT ACT (“DMCA”) NOTICE',
        content:[
    ...
    {
        loudtitle:'NOTIFICATION OF CLAIMED COPYRIGHT INFRINGEMENT',
        content:[
