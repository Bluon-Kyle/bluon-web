...
import video1 from '../../media/video/BluonLive-Video.mp4'
    ...
    <div className='distributors'>
      <div className='distributors-top'>
        ...
        <div className='distributors-top-video1'>
          <video className='dist-vid' autoPlay playsInline muted loop src={video1}></video>
        </div>
      ...
      <div className='distributors-impact bg-img-eclipse'>
        <div className='distributors-impact-text'>
          ...
          <h1>1000+ <br></br>Distributors on the<br></br> BluonLive Network</h1>
          <h3>What are you waiting for?</h3>
        </div>


        <div className='distributors-impact-map'>
          <img className='distributors-impact-map-img' src={map} alt="bluon live map" ></img>
        </div>
      </div>
      ...
      <div className='distributors-video2'>
        ...
        <div className='distributors-video2-demo-button'>
          <Link className='distributors-video2-demo-button-link' to={'/RequestDemo'}>
