...
import video1 from '../../media/video/BluonAnimation.mp4';
  ...
  return (
    <div className='home'>
      <div className='home-welcome-wrapper'> 
        <h1>Upgrading the <br></br>HVAC Industry</h1>
      ...
      <div className='home-impact'>
          <h3>The Bluon Impact</h3><br></br>
          <h2> The Largest HVAC Community on Earth</h2>
          <div className='home-impact-map-wrapper'>
            <span className='home-impact-map'>

            </span>
            <span className='home-impact-card'>
